...
const DEPLOYMENT_MODES = [
  {
    ...
    body: "Install Nora from the public repo, run it with Docker Compose, and keep agent operations on infrastructure you control.",
    points: [
  ...
  },
  {
    ...
    body: "Use Nora's platform mode when you want hosted-style onboarding, plan limits, and customer-facing operations under your own control.",
    points: [
        ...
        <main className="mx-auto max-w-7xl pt-10 lg:pt-12">
          <section className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_440px] lg:items-end">
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl font-black leading-[0.95] text-brand-ink sm:text-6xl">
                Open source licensing with room to operate.
              </h1>
              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-700 sm:text-lg">
                Nora is Apache-2.0 software. You can self-host it, modify it, use it commercially,
                and run it as an internal platform or hosted service while keeping deployment,
                billing, infrastructure, and support under your control.
              </p>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-brand-cyan px-6 py-3 text-sm font-black text-brand-ink shadow-lg shadow-brand-cyan/25 transition-transform hover:-translate-y-0.5"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-brand-cyan/40 bg-brand-cyan/20 px-6 py-3 text-sm font-bold text-brand-ink transition-colors hover:bg-brand-cyan/30"
                >
          ...
          <section className="grid gap-8 pb-14 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
            <div>
              ...
              <p className="mt-5 max-w-lg text-base leading-8 text-slate-700">
                The repo, quick start, account entry, and license terms are all visible up front so
                teams can evaluate Nora before deciding whether to self-host or build a hosted
                offering around it.
              </p>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-start">
              <div>
                ...
                <p className="mt-5 max-w-xl text-base leading-8 text-slate-700">
                  Review the source, run the quick start, create an account, and confirm the
                  Apache-2.0 rights before you bring Nora into your own operating environment.
                </p>
              </div>
