 ...
 *
 * Strict sync surfaces Hermes auth or manifest-install failures and OpenClaw manifest-delivery
 * failures. Hermes manifest input and OpenClaw gateway env projection remain best effort.
 *
 * @param {string} agentId - Agent whose integration state should be projected.
 * @param {Object} [options={}] - Strict manifest and Hermes auth failure policies.
