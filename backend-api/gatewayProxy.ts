 ...
 * Gateway credentials are decrypted only after the target has been validated.
 *
...
/**
 * Build owner-scoped OpenClaw gateway routes, including chat, RPC, and SSRF-safe UI proxying.
 *
