...
<Card title="Enterprise-capable" icon="buildings">
  ...
  and AWS / Azure / GCP rollouts. Proxmox unprivileged LXC placement is experimental and still
  requires real-hardware smoke before production use. It is not a toy dashboard — it is designed to
  grow with operator requirements.
</Card>
...
| **NemoClaw sandbox profile** | Experimental | GPU-backed secure-sandbox evaluation with explicit contract validation                                                  |
