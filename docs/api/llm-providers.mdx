...
<CodeGroup>
  ...
  curl http://localhost:8080/api/llm-providers/available \ -H "Authorization: Bearer $TOKEN" ```
</CodeGroup>
...
<CodeGroup>
  ```bash curl theme={null}
  curl http://localhost:8080/api/llm-providers \ -H "Authorization: Bearer $TOKEN" ```
</CodeGroup>
...
<CodeGroup>
  ```bash curl theme={null}
  curl -X DELETE http://localhost:8080/api/llm-providers/f1e2d3c4-b5a6-7890-abcd-012345678901 \ -H
