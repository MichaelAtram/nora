...
<Note>
  Existing agents are not affected when you switch modes. The mode change only affects how new
  deployment requests are evaluated and what resource limits are applied.
</Note>
